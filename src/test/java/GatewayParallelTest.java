 ...
 */
public class GatewayParallelTest {
    ...
    public void testDeploy() {
        ...
        Deployment deploy = repositoryService.createDeployment()
                .addClasspathResource("holiday-gateway-parallel.bpmn20.xml")
                .name("请假审批单-并行网关")
                .deploy();
    ...
    public void testProcessRun() {
        ...
        map.put("num", "3");
        ProcessInstance processInstance = runtimeService.startProcessInstanceByKey("holiday-gateway-parallel", map);
